...
use super::engine::transport::{descriptor_for, known_kinds};
...
use crate::infrastructure::drivers::vendors::generic::devices::common::ring_led_positions;
...
pub(in crate::domain::plugin) const SUPPORTED_CAPABILITIES: &[&str] = &[
    "lighting",
    "cooling",
    "sensors",
    "battery",
