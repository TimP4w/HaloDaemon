...
use crate::infrastructure::http::{HttpRequest, HttpResponse, HttpRuntime};
...
mod tests {
    use super::*;
    use crate::infrastructure::http::{HttpBackend, HttpPolicy};
    ...
    fn runtime(backend: Arc<StubBackend>) -> HttpRuntime {
        let config = crate::domain::plugin::manifest::HttpConfig {
