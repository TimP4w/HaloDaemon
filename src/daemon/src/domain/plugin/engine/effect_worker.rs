...
pub struct EffectFrameInput {
    ...
    pub dt: f32,
    pub frame: u64,
    pub audio: crate::infrastructure::audio::SpectrumFrame,
}
...
fn effect_context_table(
    ...
    context.set(
        ...
        lua.create_function(move |lua, (_self, key): (Table, String)| {
            ...
            crate::application::bus::data_bus::snapshot_to_lua(lua, &data.bus.read(&key))
        })?,
    )?;
...
mod tests {
    ...
    fn frame(time: f32, frame: u64) -> EffectFrameInput {
        EffectFrameInput {
            ...
            dt: 0.016,
            frame,
            audio: crate::infrastructure::audio::SpectrumFrame {
                level: 0.4,
                flux: 0.2,
                beat: true,
                seq: 9,
