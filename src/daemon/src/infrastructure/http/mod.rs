...
use crate::infrastructure::drivers::WriteRateLimiter;
    ...
    pub fn from_config(
        ...
        let origins = config
            ...
            .filter_map(|origin| {
                ...
                if let Err(error) = crate::domain::plugin::manifest::validate_http_origin(
                    &resolved,
...
/// runs requests, shared with the Lua worker via [`crate::domain::plugin::engine::http_api`].
#[derive(Clone)]
