...
impl Command {
    pub fn to_json(self) -> serde_json::Value {
        match self {
            Self::SetFanCurvePreset {
                fan_id,
                preset_id,
                sensor_id,
            } => serde_json::to_value(DaemonCommand::SetFanCurvePreset {
                fan_id,
                preset: preset_id,
                sensor_id,
            })
            .expect("DaemonCommand serialisation is infallible"),
            Self::SetFanCurvePoints {
                fan_id,
                points,
                sensor_id,
            } => serde_json::to_value(DaemonCommand::SetFanCurvePoints {
                fan_id,
                points,
                sensor_id,
            })
            ...
            Self::SetEqPreset {
                device_id,
                preset_index,
            } => serde_json::to_value(DaemonCommand::SetEqPreset {
                id: device_id,
                preset_index,
            })
            .expect("DaemonCommand serialisation is infallible"),
            Self::SetEqBands { device_id, values } => {
                serde_json::to_value(DaemonCommand::SetEqBands {
                    id: device_id,
                    values,
                })
                .expect("DaemonCommand serialisation is infallible")
            ...
            Self::SetDpiSteps { device_id, steps } => {
                serde_json::to_value(DaemonCommand::SetDpiSteps {
                    id: device_id,
                    steps,
                })
                .expect("DaemonCommand serialisation is infallible")
            }
            Self::RgbApply { device_id, state } => serde_json::to_value(DaemonCommand::RgbApply {
                id: device_id,
                state,
            })
            .expect("DaemonCommand serialisation is infallible"),
            ...
            Self::SetChoice {
                ...
                key,
                selected,
            } => serde_json::to_value(DaemonCommand::SetChoice {
                id: device_id,
                key,
                selected,
            })
            ...
            Self::SetRange {
                ...
                key,
                value,
            } => serde_json::to_value(DaemonCommand::SetRange {
                id: device_id,
                key,
                value,
            })
            ...
            Self::SetBoolean {
                ...
                key,
                value,
            } => serde_json::to_value(DaemonCommand::SetBoolean {
                id: device_id,
                key,
                value,
            })
            ...
            Self::CanvasOp(v) => v,
            Self::AddProfile { name } => serde_json::to_value(DaemonCommand::AddProfile { name })
                .expect("DaemonCommand serialisation is infallible"),
            ...
            Self::AddAppRule {
                ...
                profile,
                enabled,
            } => serde_json::to_value(DaemonCommand::AddAppRule {
                process_names,
                profile,
                enabled,
            })
            ...
            Self::UpdateAppRule {
                ...
                profile,
                enabled,
            } => serde_json::to_value(DaemonCommand::UpdateAppRule {
                index,
                process_names,
                profile,
                enabled,
            ...
            Self::Rediscover => serde_json::to_value(DaemonCommand::Rediscover)
                .expect("DaemonCommand serialisation is infallible"),
